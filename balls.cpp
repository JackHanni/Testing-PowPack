...
Camera camera;
Ball redBall =   Ball(1, RED,   /*height: */ 0, /*lateral1: */ checkerboard.centerx(), /*lateral2: */ checkerboard.centerz());
Ball greenBall = Ball(1, GREEN, /*height: */ 5, /*lateral1: */ checkerboard.centerx(), /*lateral2: */ checkerboard.centerz());
...
//  for(std::vector<Ball> :: iterator ballsIterator = balls.begin(); ballsIterator != balls.end(); ++ballsIterator) {
